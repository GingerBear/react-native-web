...
const ReactNative = {
  ...
  createElement: _module.createElement,
  ...
  FlatList: _module.FlatList,
  Image: _module.Image,
  KeyboardAvoidingView: _module.KeyboardAvoidingView,
  ListView: _module.ListView,
  Modal: _module.Modal,
  Picker: _module.Picker,
  ProgressBar: _module.ProgressBar,
  RefreshControl: _module.RefreshControl,
  ScrollView: _module.ScrollView,
  SectionList: _module.SectionList,
  Slider: _module.Slider,
