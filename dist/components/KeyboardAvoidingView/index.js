...
const _jsxFileName = 'src/components/KeyboardAvoidingView/index.js';
...
const KeyboardAvoidingView = (function(_Component) {
  ...
  function KeyboardAvoidingView() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          KeyboardAvoidingView.__proto__ || Object.getPrototypeOf(KeyboardAvoidingView)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
  ...
  _createClass(KeyboardAvoidingView, [
    ...
    { key: 'onKeyboardChange', value: function onKeyboardChange(event) {} },
    {
      key: 'onLayout',
...
KeyboardAvoidingView.defaultProps = { keyboardVerticalOffset: 0 };
