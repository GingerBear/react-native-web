...
const _TextPropTypes = require('./TextPropTypes');
...
const Text = (function(_Component) {
  ...
  function Text() {
    ...
    return _possibleConstructorReturn(
      this,
      (Text.__proto__ || Object.getPrototypeOf(Text)).apply(this, arguments)
    );
  }
  _createClass(Text, [
    {
...
Text.childContextTypes = { isInAParentText: _propTypes.bool };
Text.contextTypes = { isInAParentText: _propTypes.bool };
...
var styles = _StyleSheet2.default.create({
  ...
  isInAParentText: { fontFamily: 'inherit', fontSize: 'inherit', whiteSpace: 'inherit' },
