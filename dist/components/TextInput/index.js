...
const _TextInputStylePropTypes = require('./TextInputStylePropTypes');
const _TextInputStylePropTypes2 = _interopRequireDefault(_TextInputStylePropTypes);
const _TextInputState = require('./TextInputState');
...
const isAndroid =
  _ExecutionEnvironment.canUseDOM && /Android/i.test(navigator && navigator.userAgent);
const emptyObject = {};
const normalizeEventHandler = function normalizeEventHandler(handler) {
  return function(e) {
    if (handler) {
...
const TextInput = (function(_Component) {
  ...
  function TextInput() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref = TextInput.__proto__ || Object.getPrototypeOf(TextInput)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      ...
      (_this._handleBlur = function(e) {
        const onBlur = _this.props.onBlur;
        if (onBlur) {
          onBlur(e);
        }
      }),
  ...
  _createClass(TextInput, [
    {
      key: 'blur',
      value: function blur() {
        _TextInputState2.default.blurTextInput(this._node);
      }
    },
    {
      key: 'clear',
    ...
    },
    {
      ...
      value: function focus() {
        _TextInputState2.default.focusTextInput(this._node);
      }
    },
    {
      key: 'isFocused',
...
TextInput.propTypes =
  process.env.NODE_ENV !== 'production'
    ? _extends({}, _ViewPropTypes2.default, {
        ...
        keyboardType: (0, _propTypes.oneOf)([
          'default',
          'email-address',
          'number-pad',
          'numeric',
