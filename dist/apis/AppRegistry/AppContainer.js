...
const _jsxFileName = 'src/apis/AppRegistry/AppContainer.js';
  ...
  function AppContainer() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref = AppContainer.__proto__ || Object.getPrototypeOf(AppContainer)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      _this)),
      (_this.state = { mainKey: 1 }),
      _temp)),
      ...
      value: function render() {
        return _react2.default.createElement(
          _View2.default,
          {
            ...
            style: [styles.appContainer, _StyleSheet2.default.absoluteFill],
...
AppContainer.childContextTypes = { rootTag: _propTypes.any };
exports.default = AppContainer;
AppContainer.propTypes =
  process.env.NODE_ENV !== 'production'
    ? { children: _propTypes.node, rootTag: _propTypes.any.isRequired }
    : {};
var styles = _StyleSheet2.default.create({ appContainer: { flex: 1 } });
